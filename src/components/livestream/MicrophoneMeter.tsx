...
export function MicrophoneMeter({ stream }: MicrophoneMeterProps) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <div className="relative">
        ...
        {stream && isActive && (
          <div className="absolute top-1 left-1 text-[10px] text-green-400 pointer-events-none">
            Live
          </div>
        )}
      </div>
