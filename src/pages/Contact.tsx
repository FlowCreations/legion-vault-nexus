      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-center gap-4 mb-12">
            <a href="https://www.tiktok.com/@sonsoflegionmusic" target="_blank" rel="noopener noreferrer" 
            ...
            <a href="https://open.spotify.com/artist/4WBCjNjq0MGPsvcXyOPWKW" target="_blank" rel="noopener noreferrer"
               className="w-12 h-12 bg-[#2D2D2D] text-white flex items-center justify-center hover:bg-[#3D3D3D] transition-colors">
            ...
            <a href="https://music.apple.com/us/artist/sons-of-legion/1532761840" target="_blank" rel="noopener noreferrer"
               className="w-12 h-12 bg-[#2D2D2D] text-white flex items-center justify-center hover:bg-[#3D3D3D] transition-colors">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://x.com/SonsOfLegion_" target="_blank" rel="noopener noreferrer"
               className="w-12 h-12 bg-[#2D2D2D] text-white flex items-center justify-center hover:bg-[#3D3D3D] transition-colors">
